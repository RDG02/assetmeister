...
<head>
    ...
    <link rel="apple-touch-icon"
          href="{{ ($snipeSettings) && ($snipeSettings->favicon!='') ?  Storage::disk('public')->url(e($snipeSettings->logo)) :  config('app.url').'/img/custom-icon.svg' }}">
    <link rel="apple-touch-startup-image"
          href="{{ ($snipeSettings) && ($snipeSettings->favicon!='') ?  Storage::disk('public')->url(e($snipeSettings->logo)) :  config('app.url').'/img/custom-icon.svg' }}">
    <link rel="shortcut icon" type="image/svg+xml"
          href="{{ ($snipeSettings) && ($snipeSettings->favicon!='') ?  Storage::disk('public')->url(e($snipeSettings->favicon)) : config('app.url').'/img/custom-icon.svg' }}">
                    ...
                    <div class="nav navbar-nav navbar-left">
                        <div class="left-navblock">
                            <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}">
                                ...
                                @else
                                    <img class="navbar-brand-img"
                                         src="{{ config('app.url') }}/img/custom-icon.svg"
                                         alt="Logo" style="max-height: 40px;">
                                @endif
                            </a>
                        </div>
